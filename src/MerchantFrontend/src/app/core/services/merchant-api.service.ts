      ...
      .pipe(
        map((merchantData: any) => {
          return {
            ...
            trxpsProdKey: merchantData.trxpsProdKey,
            trxpsTestKey: merchantData.trxpsTestKey,
            trxpsProdShopId: merchantData.trxpsProdShopId,
            trxpsTestShopId: merchantData.trxpsTestShopId,
            trxpsTestEnabled: merchantData.trxpsTestEnabled,
